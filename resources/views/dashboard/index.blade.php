          ...
          <div class="card">
            ...
            <div class="card-body pb-0">
              ...
              <div class="form-group">
                ...
                <input disabled class="form-control" value="{{ myEvent()->location_event  }}" type="text">
              </div>
              <div class="form-group">
        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="card-header-action">
              <a href="{{ url('/arrival-log') }}" class="btn btn-primary btn-sm">lihat lainnya <i class="fa fa-arrow-right"></i></a>
            </div>
          </div>
